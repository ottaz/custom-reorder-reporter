 ...
 *	reportform.php
 *
 *	user interface page for the report generator
 */
...
$link = mysqli_connect($config['mysqlHost'], $config['mysqlUser'], $config['mysqlPass'], '', $config['mysqlPort'] + 0);
...
<script>
	function myFunction() {
		alert("LSS Customer Reorder Reporter v2.0\n\nReturns all products whose reorder point is equal to or exceeds the available quantity\n\nWHY? Lightspeed Onsite currently compares with the total and not the available quantity.");
	}
</script>
<body>
